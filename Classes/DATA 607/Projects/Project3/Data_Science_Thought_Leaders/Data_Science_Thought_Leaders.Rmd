...
```{r}
thoughtleaders <- read.csv('thought_leaders.csv', header = TRUE)
```
...
tag_ex <- read.csv('keyword_tags.csv', header = TRUE)
...
```{r}
#read from csv
an_df <- read.csv('an_Ng.csv', header = TRUE)
```
...
```{r}
#read from csv
kira_df <- read.csv('kira_radinsky.csv', header = TRUE)
```

```{r}
#read from csv
allkw <- read.csv('kr_keywords.csv', header = TRUE)
